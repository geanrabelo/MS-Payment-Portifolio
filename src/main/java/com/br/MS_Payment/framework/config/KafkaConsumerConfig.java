...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ReceiveOrderEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.br.MS_Payment.framework.dto.ReceiveOrderEvent");
    ...
    public ConcurrentKafkaListenerContainerFactory<String, ReceiveOrderEvent> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, ReceiveOrderEvent> factory =
